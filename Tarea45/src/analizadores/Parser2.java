  ...
  public final java_cup.runtime.Symbol CUP$Parser2$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser2$act_num)
		...
		Nodo2 l = (Nodo2)((java_cup.runtime.Symbol) CUP$Parser2$stack.peek()).value;
		raiz = l;
		...
		Nodo2 l = (Nodo2)((java_cup.runtime.Symbol) CUP$Parser2$stack.elementAt(CUP$Parser2$top-2)).value;
		...
		int pright = ((java_cup.runtime.Symbol)CUP$Parser2$stack.peek()).right;
		String p = (String)((java_cup.runtime.Symbol) CUP$Parser2$stack.peek()).value;
		RESULT = new Nodo2(); RESULT.pares += Integer.parseInt(p); RESULT.contadorPar++;
		...
		int pright = ((java_cup.runtime.Symbol)CUP$Parser2$stack.peek()).right;
		String p = (String)((java_cup.runtime.Symbol) CUP$Parser2$stack.peek()).value;
		RESULT = new Nodo2(); RESULT.impares = RESULT.impares * Integer.parseInt(p); RESULT.contadorImpar++;
              CUP$Parser2$result = parser.getSymbolFactory().newSymbol("LISTA",1, ((java_cup.runtime.Symbol)CUP$Parser2$stack.peek()), ((java_cup.runtime.Symbol)CUP$Parser2$stack.peek()), RESULT);
            }
          return CUP$Parser2$result;
